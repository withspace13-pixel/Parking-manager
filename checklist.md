...
# 솔라피 잔액 배지 = 콘솔 잔액 합계 (2026-08-13)

- [x] getBalance 원본 확인 (deposit 11125, balance 10012.5, balanceOnly 0)
- [x] 배지 금액을 `balanceOnly + deposit`으로 표시
- [ ] 개발 서버에서 새로고침 후 11,125원인지 확인
